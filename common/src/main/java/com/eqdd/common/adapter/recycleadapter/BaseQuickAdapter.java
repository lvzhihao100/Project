 ...
 */
package com.eqdd.common.adapter.recycleadapter;
...
import com.eqdd.common.adapter.recycleadapter.animation.AlphaInAnimation;
import com.eqdd.common.adapter.recycleadapter.animation.BaseAnimation;
import com.eqdd.common.adapter.recycleadapter.animation.ScaleInAnimation;
import com.eqdd.common.adapter.recycleadapter.animation.SlideInBottomAnimation;
import com.eqdd.common.adapter.recycleadapter.animation.SlideInLeftAnimation;
import com.eqdd.common.adapter.recycleadapter.animation.SlideInRightAnimation;
import com.eqdd.common.adapter.recycleadapter.entity.IExpandable;
import com.eqdd.common.adapter.recycleadapter.loadmore.LoadMoreView;
import com.eqdd.common.adapter.recycleadapter.loadmore.SimpleLoadMoreView;
...
public abstract class BaseQuickAdapter<T, K extends BaseViewHolder> extends RecyclerView.Adapter<K>
     ...
     * @param datas
     */
    public void addAllData(List<T> datas,boolean isRefresh) {
        if (isRefresh){
            mData.clear();
        }
        mData.addAll(datas);
...
//        return mLayoutInflater.inflate(layoutResId, parent, false);
    ...
    public boolean isEmpty() {
        return (mData.size()+getHeaderLayoutCount())<=0;
    }
}
