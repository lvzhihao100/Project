...
import com.eqdd.library.SelectQunMemberActivityCustom;
...
@Route(path = Config.LIBRARY_SELECT_QUN_MEMBER)
public class SelectQunMemberActivity extends CommonActivity {
    private SelectQunMemberActivityCustom dataBinding;
    ...
    public void initBinding() {
        dataBinding = DataBindingUtil.setContentView(this, R.layout.library_activity_qun_member);
        initTopTitleBar(View.VISIBLE, "选择群成员");
